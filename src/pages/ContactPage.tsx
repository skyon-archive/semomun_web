...
export const ContactPage = () => {
  return (
    <div className="w-full flex justify-center space-y-16">
      <div className="max-w-5xl md:bg-brand-3 flex flex-col items-center w-full min-h-screen-12 space-y-6 md:space-y-10 py-4 md:py-10">
        <h2 className="font-bold text-2xl md:text-3xl">기업문의</h2>
        <Semomun />
        <div className="flex flex-col space-y-4 text-sm items-center md:items-start text-center md:text-left px-10 break-keep">
          <p>안녕하세요.</p>
          <p className="font-medium md:font-bold">
            저희는{" "}
            <span className="font-bold">“새로운 온라인 교육 패러다임”</span>을
            만드는 기업 <span className="font-bold">스카이온</span> 입니다.
          </p>
          <p>
          ...
          <p>
            스카이온에듀는 출판사들의 문제집을 <br className="md:hidden" />
            <span className="font-bold md:font-normal">“E-문제집”</span>
            <br className="md:hidden" />
            으로 전환 시켜드리는 사업을 진행하고 있습니다.
            <br />
            <br className="md:hidden" />
